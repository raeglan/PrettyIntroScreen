package de.alfingo.prettyintroscreen;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSlidesViewPager = (ViewPager) findViewById(R.id.welcome_view_pager);
        mDotsLinearLayout = (LinearLayout) findViewById(R.id.welcome_layoutDots);
        mNextButton = (Button) findViewById(R.id.welcome_btn_next);
        mSkipButton = (Button) findViewById(R.id.welcome_btn_skip);
    ...
    private class SliderViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            TextView title = (TextView) itemView.findViewById(R.id.item_welcome_title);
            TextView description = (TextView) itemView.findViewById(R.id.item_welcome_description);
            ImageView image = (ImageView) itemView.findViewById(R.id.item_welcome_image);
